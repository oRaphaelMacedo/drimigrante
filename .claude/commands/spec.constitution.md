...
validation_scripts:
   sh: .spec/scripts/bash/validate-constitution.sh
   ps: .spec/scripts/powershell/validate-constitution.ps1
handoffs: 
...
1. **Load Team Constitution**
   - Execute: `.spec/scripts/bash/setup-constitution.sh` to access team directives
...
1. **Template Processing**
   - Load constitution template from `{REPO_ROOT}/.spec/templates/constitution-template.md`
...
1. **Automated Validation**
   - Execute: `{VALIDATION_SCRIPT} --compliance --strict .spec/memory/constitution.md`
...
1. **Artifact Generation**
    - Write validated constitution to `.spec/memory/constitution.md`
...
Use `.spec/templates/constitution-template.md` for initial creation and `.spec/memory/constitution.md` for updates.
